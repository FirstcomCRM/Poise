<script>
  ...
  $(function(){
     var tbl = $('#service-table').dataTable({
        "processing": true,
        "serverSide": true,
        'iDisplayLength': 20,
        //'bFilter': false, 
    ...
    // Quick Edit
    $('#tbl-service').on('click', '.edit-link', function(e) { 
      e.preventDefault();
      var id = getIdfromURL($(this).attr('href'));
      var editurl = 'service/aj_edit/' + id;
      getEditvalues(editurl);
      var updateurl = 'service/edit/' + id;
    ...
    //Quick Delete
    $('#tbl-service').on('click', '.delete-link', function(e) {
      e.preventDefault();
...
<div class="modal fade" id="myModal" tabindex="-1" service="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div class="modal fade" id="quickModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel"><span class="quick-action"></span> Service</h4>
      </div>
      <div class="modal-body">
        <form role="form" id="quick-form">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control input-sm" id="name" name="name" placeholder="Enter Service Name" value="" required>
                </div>
		...
		<div class="box">		  
          <div class="box-header">
			...
			<div class="box-body">
				...
				<?php } ?>
				<div class="row-fluid table-responsive" id="tbl-service">
					<div class = "col-md-12">
						<table class="table table-striped table-bordered dataTable no-footer" id = 'service-table'>
							<thead>
							  <tr>
								  <th>No</th>
								  <th>Name</th>
