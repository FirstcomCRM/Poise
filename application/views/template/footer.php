      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?=date('Y')?> <a href="#">Firstcom Solutions Pte Ltd.</a>.</strong> All rights reserved.
      </footer>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- AdminLTE for demo purposes -->
			...
			<script src="<?= base_url(); ?>js/js/vendor/jquery.ui.widget.js"></script>
