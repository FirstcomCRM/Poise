...
<script>
  ...
  $(function(){
    ...
    $("#end-date").datepicker({
     ...
     var tbl = $('#receipt-table').dataTable({
        "processing": true,
        "serverSide": true,
        'iDisplayLength': 20,
    ...
    $('#tbl-receipt').on('click', '.view-link', function(e) { 
      e.preventDefault();
      var id = getIdfromURL($(this).attr('href'));
      $.ajax({
        type :  "POST",
        url  :  burl + 'receipt/view/' + id,
        data :  { },
        success: function(data){ 
          $('#view-receipt-detail').html(data); 
    ...
    //Quick Delete
    $('#tbl-receipt').on('click', '.delete-link', function(e) {
      e.preventDefault();
...
<div class="modal fade" id="myModal" tabindex="-1" receipt="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div class="modal fade" id="viewModal" tabindex="-1" class="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">View Receipt Detail</h4>
      </div>
      <div class="modal-body" id="view-receipt-detail">
		...
		<div class="box">
          <div class="box-header">
			 ...
			 <div class="pull-right">
			  <a href="<?= base_url().'receipt/create'; ?>" class="btn btn-default btn-flat">Add</a>
			 </div>
           </div><!-- /.box-header -->
			<div class="box-body">
				...
				<?php } ?>
				<div class="row-fluid table-responsive" id="tbl-receipt">
					<div class = "col-md-12">
						<table class="table table-striped table-bordered dataTable no-footer" id = 'receipt-table'>
							<thead>
							  <tr>
								 <th>No</th>
								 <th>Receipt No</th>
