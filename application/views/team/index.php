<script>
  ...
  $(function(){
    ...
    // Quick Edit
    $('#tbl-team').on('click', '.edit-link', function(e) { 
      e.preventDefault();
      var id = getIdfromURL($(this).attr('href'));
      var editurl = 'team/aj_edit/' + id;
      getEditvalues(editurl);
      var updateurl = 'team/edit/' + id;
    ...
    //Quick Delete
    $('#tbl-team').on('click', '.delete-link', function(e) {
      e.preventDefault();
...
<div class="modal fade" id="myModal" tabindex="-1" team="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div class="modal fade" id="quickModal" tabindex="-1" team="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel"><span class="quick-action"></span> Team Management</h4>
      </div>
      <div class="modal-body">
        <form team="form" id="quick-form">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control input-sm" id="name" name="name" placeholder="Enter team Name" value="<?php echo isset($_POST['name']) ? $_POST['name'] : ( isset($team['name']) ? $team['name'] : '') ; ?>" required>
                </div>
		...
		<div class="box">		  
          <div class="box-header">
			 ...
			 <div class="pull-right">
				<!--a href="<?= base_url().'team/create'; ?>" class="btn btn-default btn-flat"><i class="fa fa-plus ico-btn"></i>Add</a-->
