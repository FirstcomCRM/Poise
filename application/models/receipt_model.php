...
class receipt_model extends CI_Model {
	...
	public function getdtreceipts() {
		...
		$this->datatables->add_column('action', '<ul class="list-inline hidden-xs"><li class = "li-padds"><a class="btn btn-mtac admin-control btn-view btn-primary view-link" data-toggle="tooltip" data-placement="top" title="View" href="receipt/view/$1">View</a></li>'.$edit.'<li class = "li-padds"><a class="btn btn-mtac admin-control btn-view btn-warning" data-toggle="tooltip" data-placement="top" title="Print" href="receipt/printReceipt/$1">Print</a><li class = "li-padds"><a class="btn btn-mtac btn-delete btn-danger delete-link" data-toggle="tooltip" data-placement="top" title="Delete" href="announcement/delete/$1">Delete</a></li></ul>', 'receipt_id');
