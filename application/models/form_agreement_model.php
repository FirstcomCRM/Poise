...
class form_agreement_model extends CI_Model {
	...
	public function getdtforms() {
		...
		if($role_id == 1) {
			$edit= '<li class = "li-padds"><a class="btn btn-mtac admin-control btn-view btn-success" data-toggle="tooltip" data-placement="top" title="Edit" href="form_agreement/edit/$1">Edit</a></li>';
		} 
		else{
			$edit ='';
		}
		...
		$this->datatables->add_column('action', '<ul class="list-inline hidden-xs"><li class = "li-padds"><a class="btn btn-mtac admin-control btn-view btn-primary view-link" data-toggle="tooltip" data-placement="top" title="View" href="form_agreement/view/$1">View</a>'.$edit.'</li><li class = "li-padds"><a class="btn btn-mtac btn-delete btn-danger delete-link" data-toggle="tooltip" data-placement="top" title="Delete" href="form_agreement/delete/$1">Delete</a></li></ul>', 'form_id');
